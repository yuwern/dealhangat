<?php /* SVN: $Id: add_to_wallet.ctp 59489 2011-07-08 08:32:11Z arovindhan_144at11 $ */ ?>
...
<?php 
	...
	<span class="info"> <?php echo sprintf(__l('Minimum Amount: %s <br/> Maximum Amount: %s'),$this->Html->siteCurrencyFormat($this->Html->cCurrency(Configure::read('wallet.min_wallet_amount'))), $max_amount)?>  </span>
	<?php
		  ...
		  <h3><?php echo __l('Billing Information'); ?></h3>
			<?php
				...
				<?php echo $this->Form->month('User.expDateMonth', array('value' => date('m')));
			     echo $this->Form->year('User.expDateYear', date('Y'), date('Y')+25, array('value' => date('Y')+2));?>
				</div>
