...
<h2><?php echo __l('Deal Coupons').' - '.$deal['Deal']['name'];?></h2>
...
?>
	<tr<?php echo $class;?>>
		...
		<td><?php echo $this->Html->cBool($dealCoupon['DealCoupon']['is_used']);?></td>
...
?>
	<tr>
		<td colspan="6" class="notice"><?php echo __l('No Deal Coupons available');?></td>
	</tr>
<?php
endif;
?>
