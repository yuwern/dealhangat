<?php /* SVN: $Id: edit.ctp 55147 2011-05-31 11:13:31Z aravindan_111act10 $ */?>
			...
			<fieldset class="form-block round-5">
				...
				<div class="clearfix input-blocks">
					<div class=" input-block-left">
						<?php echo $this->Form->input('min_limit', array('label'=>__l('No. of min. coupons'), 'info' => __l('Minimum limit of coupons to be bought by users, in order for the deal to get tipped.'))); ?>
					</div>
					<div class="js-subdeal-not-need <?php echo (!empty($this->request->data['Deal']['is_subdeal_available']) ? 'hide' : '');?>">        
