		...
		<div class="buy-button">
            <?php
				if(empty($deal['Deal']['is_subdeal_available'])){
					$site_buy_url = str_ireplace('touch.', 'm.', Router::url(array('controller' => 'deals', 'action' => 'buy', $deal['Deal']['id']), true));
					echo $this->Html->link(__l('Buy'), $site_buy_url, array('target' => '_blank', 'title' => __l('Buy'),'data-theme'=>'b', 'data-role' => 'button', 'class' =>'buy-but'));
				} 
			?>		
            </div>
...
if(!empty($deal['Deal']['is_subdeal_available'])){
		...
		<ul data-role="listview">
			<li data-role="list-divider"><?php echo ' '.__l('Choose your deal'); ?><span class="ui-li-count"><?php echo count($deal['SubDeal']);?></span></li>
				<?php foreach($deal['SubDeal'] as $subdeal){ 
					$site_buy_url = str_ireplace('touch.', 'm.', Router::url(array('controller' => 'deals', 'action' => 'buy', $deal['Deal']['id'], $subdeal['id']), true));
					?>
					<li>
					<a target="_blank" href="<?php echo $site_buy_url; ?>" class="fade">
	...
	<ul data-role="listview">
        ...
        <?php endif; ?>    
        <li data-role="list-divider"><?php echo __l('Company');?></li>
        	<li>
