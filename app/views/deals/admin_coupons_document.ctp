...
echo "<tr><td><b>Deal Name:</b></td><td  colspan='5'>".$deal['Deal']['name_ms']."</td></tr>";
...
//echo "<tr><td><b>Partner's:</b></td><td  colspan='5'>".$partner_amount."RM </td></tr>";
...
echo "<tr><td>First Payment</td><td>End sales date + 5 days</td><td> RM y /2 </td></tr>";
echo "<tr><td>Final Payment</td><td>End redemption date  + 5</td><td>RM  y /2</td></tr>";
echo "</table>";
