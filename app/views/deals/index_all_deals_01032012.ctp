                    ...
                    <div class="share">
                       <span><?php echo __l('Share This Deal: '); ?></span>
                        <ul class="share-list">               
							...
							<li class="tw"><a href="http://twitter.com/share?url=<?php echo $bityurl;?>&amp;text=<?php echo urlencode_rfc3986($deal['Deal']['name'], false);?>&amp;lang=en&amp;via=<?php echo Configure::read('site.name'); ?>" data-count="none" class="twitter-share-button"><?php echo __l('Tweet!');?></a></li>
