<?php /* SVN: $Id: view.ctp 7480 2010-06-09 06:19:22Z senthilkumar_017ac09 $ */ ?>
    ...
    <div class="clearfix">
      ...
      <div class="side2">
        <p class="cash"><?php echo (empty($deal['Deal']['is_subdeal_available'])) ? $this->Html->siteCurrencyFormat($this->Html->cCurrency($deal['Deal']['discounted_price'])) : $this->Html->siteCurrencyFormat($this->Html->cCurrency($deal['SubDeal'][0]['discounted_price']));?></p>
		<?php
            if($this->Html->isAllowed($this->Auth->user('user_type_id')) && $deal['Deal']['deal_status_id'] != ConstDealStatus::Draft && $deal['Deal']['deal_status_id'] != ConstDealStatus::PendingApproval):
                if($deal['Deal']['deal_status_id'] == ConstDealStatus::Open || $deal['Deal']['deal_status_id'] == ConstDealStatus::Tipped):
                            if(empty($deal['Deal']['is_subdeal_available'])){
								 ...
								 echo $this->Html->link(__l('Buy'), '#', array('title' => __l('Buy'),'class' =>"buy-but round-5 js-multiple-sub-deal {'opendialog': 'js-open-subdeal-".$deal['Deal']['id']."'}"));					
							  ?>
                                	...
                                	<ul>
                                    	...
                                    	<li>                                        		
                                                <div class="clearfix deal-block">
                                                		<p> <?php echo $this->Html->cText($subdeal['name']);?></p>
                                                      <dl class="deal-list">
                                                         <dt><?php echo __l('Value');?></dt>
                                                         <dd><?php echo $this->Html->siteCurrencyFormat($this->Html->cCurrency($subdeal['original_price']));?></dd>
                                                          <dd><?php echo $this->Html->siteCurrencyFormat($this->Html->cCurrency($subdeal['discounted_price']));?></dd>
                                                      ...
                                                      <?php else: ?>
                                                      <p> <?php echo $this->Html->link('Buy Now', array('controller'=>'deals','action'=>'buy', $deal['Deal']['id'], $subdeal['id']),array('title' =>sprintf(__l('%s'),$subdeal['name'])));?></p>
                                                      <?php endif;?> 
                                                 </div>
                                        </li>
                                        <?php } ?>
