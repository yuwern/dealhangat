...
<tr>
    ...
    <tr>	
		...
		<p>
			<strong style="color:#000; font-size:20px;display:block;margin:15px 0px 10px 0px; "><?php echo $this->Html->cText($dealUser['Deal']['name']).' - '.(!empty($dealUser['SubDeal']['name']) ? $dealUser['SubDeal']['name'] : '');?></strong>
		</p>
...
<td style="width: 49%;line-height:22px; color:#000;" valign="top">
				...
				<dl style="margin:0px;padding:0px;">
				  ...
				  <dd style="width:157px;float:left;margin:0px;padding:0px 0px 0px 10px; font-family:arial;font-size:13px;">
					...
					<?php } ?>
					<?php if(!empty($company_branch_address['CompanyAddress']['address2'])) { ?>
