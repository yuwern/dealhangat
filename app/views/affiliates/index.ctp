...
<?php echo $this->element('user_affiliate_stat'); ?>
...
<?php else: ?>
	<?php echo $this->element('pages-terms_and_policies', array('cache' => array('config' => 'site_element_cache_2_min', 'key' => 'affilates')));?>
	<?php 	
	if($this->Auth->sessionValid()):
		echo $this->element('affiliate_request-add', array('cache' => array('config' => 'site_element_cache_1_min')));
    endif;
    ?>
<?php endif; ?>
