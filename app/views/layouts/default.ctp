      ...
      <div class="menu-block clearfix">
        <ul class="menu clearfix">
        	<?php if($this->Html->isAllowed($this->Auth->user('user_type_id'))): ?>
                ...
                <li <?php if($this->request->params['controller'] == 'deals' && (isset($this->request->params['named']['type']) && $this->request->params['named']['type'] == 'anytime')) { echo 'class="active"'; } else { echo 'class=""';}?>><?php echo $this->Html->link(__l('Virtual Shop'), array('controller' => 'deals', 'action' => 'index', 'admin' => false,'type' => 'anytime'), array('title' => __l('Virtual Shop')));?></li>
            <?php endif; ?>
