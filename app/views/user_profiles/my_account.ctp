<div class="js-tabs">
	<ul class="clearfix">
		...
		<li><?php echo $this->Html->link(__l('My Connections'), array('controller' => 'users', 'action' => 'profile_image', 'connect' => 'linked_accounts', $user_id, 'admin' => false), array('title' => 'My Connections', 'rel'=> '#Connect')); ?></li>
		...
		<?php if($this->Auth->user('user_type_id') != ConstUserTypes::Company):?>
			  <li><?php echo $this->Html->link(__l('Privacy Settings'), array('controller' => 'user_permission_preferences', 'action' => 'edit', $user_id, 'admin' => false), array('title' => 'Privacy Settings', 'rel' => '#Privacy_Settings'));?></li>
		<?php endif; ?>
