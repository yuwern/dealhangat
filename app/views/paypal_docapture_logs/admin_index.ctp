		...
		<td>
			<div class="actions-block">
				<div class="actions round-5-left">
					<span><?php echo $this->Html->link(__l('View'), array('controller' => 'paypal_docapture_logs', 'action' => 'view', $paypalDocaptureLog['PaypalDocaptureLog']['id']), array('class' => 'view', 'title' => __l('View')));?></span>
				</div>
			</div>
